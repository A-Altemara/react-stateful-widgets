...
export default function Programmers() {
  ...
  const [featuredProgramer, setFeaturedProgrammer] = useState(null)
  ...
  const getNameOfFeatured = () => {
    ...
    return programmers.find(dev => dev.id === featuredProgramer).name
  };

  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: featuredProgramer != null ? 'gold' : 'royalblue', // 🤔 color turns to gold, when celebrating
  };
      ...
      <div id='featured' style={style}>
        {
          ...
          (featuredProgramer != null ? `🎉 Let's celebrate ${getNameOfFeatured()}! 🥳`
