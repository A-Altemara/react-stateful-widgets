...
STEP 2:
  ...
  Airiel's comments:  This is a much better explination of what is going on with this exercise.  https://reactjs.org/docs/conditional-rendering.html#inline-if-with-logical--operator
  basically the 
...
const [spinnerOn, setSpinnerOn] = useState(true)
  ...
  return (
    <div className='widget-spinner container'>
      <h2>Spinner</h2>
      {
        // spinnerOn ?  <div id='spinner' className='spinner'>--+--</div> : false
        spinnerOn && <div id='spinner' className='spinner'>--+--</div> /* STEPs 2 */
      }
